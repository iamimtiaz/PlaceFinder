...
//                Toast.makeText(getApplicationContext(), po, Toast.LENGTH_LONG).show();
	...
	class LoadPlaces extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(MyActivity8.this);
				...
				public void run() {
					...
					if(status.equals("OK")){
						...
						if (nearPlaces.results != null) {
							...
							// list adapter
							ListAdapter adapter = new SimpleAdapter(MyActivity8.this, placesListItems,
					                R.layout.list_item,
						...
						// Zero results found
						alert.showAlertDialog(MyActivity8.this, "Near Places",
								"Sorry no places found. Try to change the types of places",
								false);
					}
					else if(status.equals("UNKNOWN_ERROR"))
					{
						alert.showAlertDialog(MyActivity8.this, "Places Error",
